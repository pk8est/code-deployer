...
/**
 * ServerRoomSearch represents the model behind the search form of `common\models\ServerRoom`.
 */
class ServerRoomSearch extends ServerRoom
{
    /**
     * @inheritdoc
     */
